...
@Component({
    selector: 'planning-definition-edit',
    templateUrl: '../templates/planning.edit.html'
})

export class PlanningEdit implements OnInit, CanComponentDeactivate {
    ...
    ngOnInit(): void {
        ...
        //this.planning.endTime = moment(this.planning.endTime).format('YYYY.MM.DD');
    ...
    private getItem(id: number): void {
        this.planningService
            ...
            .subscribe(result => {
                ...
                this.planning.startTime = moment(this.planning.startTime).format('DD.MM.YYYY');
                this.planning.endTime = moment(this.planning.endTime).format('DD.MM.YYYY');
                this.copyInput();
            });
    }
